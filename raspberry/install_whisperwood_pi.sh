...
WHISPERWOOD_SMTP_HOST="${WHISPERWOOD_SMTP_HOST:-}"
WHISPERWOOD_SMTP_PORT="${WHISPERWOOD_SMTP_PORT:-587}"
WHISPERWOOD_SMTP_USERNAME="${WHISPERWOOD_SMTP_USERNAME:-}"
WHISPERWOOD_SMTP_PASSWORD="${WHISPERWOOD_SMTP_PASSWORD:-}"
WHISPERWOOD_SMTP_FROM_EMAIL="${WHISPERWOOD_SMTP_FROM_EMAIL:-${WHISPERWOOD_SMTP_USERNAME}}"
WHISPERWOOD_SMTP_FROM_NAME="${WHISPERWOOD_SMTP_FROM_NAME:-Enhanced Living Whisperwood}"
WHISPERWOOD_SMTP_TLS="${WHISPERWOOD_SMTP_TLS:-1}"
WHISPERWOOD_SMTP_SSL="${WHISPERWOOD_SMTP_SSL:-0}"
...
install_python_apps() {
  install -d -m 0755 "${APP_ROOT}" "${CONTROL_DIR}" "${OPERATION_DIR}" \
    ...
    "${DATA_DIR}/backups" "${DATA_DIR}/firmware"
...
GDRIVE_BACKUP_TARGET=$(env_quote "${GDRIVE_BACKUP_TARGET}")
WHISPERWOOD_SMTP_HOST=$(env_quote "${WHISPERWOOD_SMTP_HOST}")
WHISPERWOOD_SMTP_PORT=$(env_quote "${WHISPERWOOD_SMTP_PORT}")
WHISPERWOOD_SMTP_USERNAME=$(env_quote "${WHISPERWOOD_SMTP_USERNAME}")
WHISPERWOOD_SMTP_PASSWORD=$(env_quote "${WHISPERWOOD_SMTP_PASSWORD}")
WHISPERWOOD_SMTP_FROM_EMAIL=$(env_quote "${WHISPERWOOD_SMTP_FROM_EMAIL}")
WHISPERWOOD_SMTP_FROM_NAME=$(env_quote "${WHISPERWOOD_SMTP_FROM_NAME}")
WHISPERWOOD_SMTP_TLS=$(env_quote "${WHISPERWOOD_SMTP_TLS}")
WHISPERWOOD_SMTP_SSL=$(env_quote "${WHISPERWOOD_SMTP_SSL}")
EOF
